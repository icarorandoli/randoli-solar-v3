...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 md:p-8 space-y-10 max-w-[1600px] mx-auto">
      ...
      {/* KPI Cards — ✅ clicáveis com navegação */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <Link key={idx} href={kpi.href}>
            <Card className={`group hover-elevate border-none bg-card shadow-md shadow-black/5 overflow-hidden rounded-2xl cursor-pointer transition-all hover:-translate-y-1`}>
              ...
              <CardContent className="p-7 relative overflow-hidden">
                ...
                <div className="flex items-center gap-1 mt-3 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  ...
                  <span className="text-[10px] font-bold text-muted-foreground/50 uppercase tracking-wider">Ver detalhes</span>
                </div>
