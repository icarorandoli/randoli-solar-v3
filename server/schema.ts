...
export const announcements = pgTable("announcements", {
  ...
  content: text("content").notNull(),
  active: boolean("active").notNull().default(true),
  targetUserIds: text("target_user_ids"), // JSON array de userIds ou null = todos
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const termTemplates = pgTable("term_templates", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  code: text("code").notNull().default("prestacao_servicos"),
  title: text("title").notNull(),
...
export const projectTermAcceptances = pgTable("project_term_acceptances", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
  projectId: varchar("project_id").notNull(),
  userId: varchar("user_id").notNull().references(() => users.id),
  integratorName: text("integrator_name").notNull(),
  integratorDocument: text("integrator_document"),
  integratorEmail: text("integrator_email"),
  ...
  termContent: text("term_content").notNull(),
...
export type ProjectTermAcceptance = typeof projectTermAcceptances.$inferSelect;
export type InsertProjectTermAcceptance = typeof projectTermAcceptances.$inferInsert;
